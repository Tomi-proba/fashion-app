  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800 dark:border-amber-900/50 dark:bg-amber-900/20 dark:text-amber-300">
        A fenti diagram a robot stratégiáját futtatja le a {robot.assetSymbol} valós, élő árfolyamán, azóta,
        hogy ez a böngésző csatlakozott az adatfolyamhoz — nem hosszú távú, valós kereskedési eredmény, és nem
        garantálja, hogy a robot a jövőben (akár csak a befektetett összeg erejéig) nyereséges lesz. Kereskedési
        díj minden ügyletnél levonásra kerül.
      </div>
